...
export const MENU_NODES: Record<string, MenuNode> = {
  ...
  scholarship: {
    ...
    quickReplies: [
      ...
      { label: "학자금대출", targetId: "scholarship-loan" },
  ...
  "scholarship-internal": {
    ...
    intro:
      "대림대학교 교내장학금 종류예요. (학교 공식 장학안내 페이지 기준 · 등록금성 장학 → 생활비성 장학 순)",
    topLink: { label: "🔍 장학안내 페이지에서 전체 표로 보기", url: OFFICIAL_LINKS.scholarship },
    cards: [
      {
        title: "입학우수장학",
        body: "전체수석: 전학년 수업료 전액감면(12학점↑·평점 4.0↑ 유지 시 정규학기 내 계속지원)\n학과수석: 1학년 1학기 수업료 전액감면\n전문기술석사(정시): 성적에 따라 전액/50%/30% 감면",
      },
      {
        title: "외국인학생장학",
        body: "외국인특별전형 신입생: TOPIK 3급 이하 20%, 4급 30%, 5급 이상 50% 감면(협약기관 추천서 지참 시)\n재직자반 외국인 재학생: 12학점↑·평점 1.5~4.0미만 시 수업료 20% 감면",
      },
      {
        title: "성적 A·B·C 장학",
        body: "직전학기 12학점(전문기술석사는 6학점) 이상 이수한 성적우수자 중 학과 배정예산 내 학과(부)장 추천\nA 전액·B 50%·C 30% 감면",
      },
      {
        title: "성적 D 장학",
        body: "산업체위탁(12학점↑)·전공심화(10학점↑) 재학생 중 성적우수자, 학과(부)장 추천\n수업료 20% 추가 감면",
      },
      {
        title: "산업체위탁장학",
        body: "산업체위탁교육 입학전형 신입생(대학-산업체 협약 시 입학학기 20% 한도 추가 감면 가능)\n재학생은 12학점↑·평점 1.5↑ 시 수업료 20% 감면",
      },
      {
        title: "전공심화장학",
        body: "학사학위 전공심화 입학전형 신입생: 수업료 30% 감면\n재학생(10학점↑·평점 1.5↑): 정규학기 수업료 30% 감면",
      },
      {
        title: "면학장학금",
        body: "편입생 · 전문학사 이상 전형 입학 신입생, 첫 학기에 한해 수업료 20% 감면",
      },
      {
        title: "외국인유학생 성적장학",
        body: "TOPIK 3급↑·직전학기 12학점↑ 성적우수자, 국제교류원장 추천(외국인학생장학과 중복수혜 불가)\n일반: 평점 4.0↑ 50%·3.5↑ 30%·2.5↑ 20% 감면 / 재직자: 평점 4.0↑ 50% 감면",
      },
      {
        title: "교내복지장학",
        body: "국가장학금 지원구간 확인자(산업체위탁·전공심화 제외), 직전학기 평점 2.5↑(장애학생은 성적 제한 없음)\n지급대상·금액은 학기별 대학 자체설계, 6월·12월 지급",
      },
      {
        title: "대림나눔장학",
        body: "장애인복지법 증명서 제출 + 해당학기 국가장학금 지원구간 8구간 이내\n수업료 50% 지급, 5월·11월, 학생포털에서 학생신청",
      },
      {
        title: "봉사장학 (A·B·C)",
        body: "총학생회장·대의원의장(평점 1.5↑): 320만원(인문사회 280만원)\n학회장·학보사국장·방송국장: 160만원(140만원)\n총학생회임원·학보사부장·방송국부장: 96만원(84만원)\n반대표 64만원·학과임원 32만원(인문사회 56/28만원), 학생홍보대사 최대 50만원, 산업체위탁 실습지원학생 32만원(28만원)\n모두 직전학기 평점 1.5↑, 5월·11월 지급(봉사C는 2종류까지 중복지급 가능)",
      },
      {
        title: "교내근로장학",
        body: "직전학기 평점 1.5↑ + 학과(행정부서) 근로 제공 학생, 근로시간만큼 매월 지급(산업체위탁 학생은 교내근로 불가)",
      },
      {
        title: "보훈장학",
        body: "보훈대상자 자녀·국가유공자 본인·북한이탈주민(학비면제대상자 증명서 제출), 평점 1.5↑\n수업료 전액감면(국고·교비), 보훈처에서 대상자 선정",
      },
      {
        title: "대림가족장학",
        body: "본교 재직 교직원의 직계가족(본인·자녀·배우자), 평점 2.5↑ + 국가장학금 신청절차 완료\n(겸임교수·시간강사·명예교수 제외) 수업료 범위 전액, 6월·12월",
      },
      {
        title: "대림사랑장학",
        body: "가족 2인 이상 동시재학 또는 가족 중 2명 이상 본교 졸업생\n1인당 30만원, 4월·11월, 학생포털에서 학생신청",
      },
      {
        title: "대림다문화장학",
        body: "직전학기 평점 2.5↑ + 다문화가족지원법상 가정의 자녀(증빙자료 제출)\n수업료 30% 지급, 5월·11월, 학생포털에서 학생신청",
      },
      {
        title: "GLOBAL 어학장학 · 글로벌리더스챌린지장학",
        body: "국제교류원 운영지침에 따름(국제교류원 추천)\n어학장학: 총장 승인금액 / 챌린지장학: 1인 200만원 한도 내 최대 32명, 5월·11월",
      },
      {
        title: "BeACE장학 · 학군단장학",
        body: "BeACE장학(취업처 추천)·해군 부사관학군단 후보생 장학(해당부서 추천), 총장 승인금액, 5월·11월",
      },
      {
        title: "특별장학 · 장학사정관제장학",
        body: "특별장학: 총장이 특별히 필요하다고 인정하는 학생(총장 승인 시)\n장학사정관제장학: 장학 소외계층 맞춤형, 학과(부)장 추천, 5월·11월",
      },
      {
        title: "공통 유의사항",
        body: "신입생은 첫 학기 성적기준 미적용 · 장학금은 최소 10만원 이상 지급 원칙\n휴학 시 등록금감면 목적 장학은 수혜 취소되며 복학 후 재수혜 불가\n보훈·새터민·중소기업취업연계·농림축산식품부·푸른등대·고졸후학습자·전문기술인재 장학 수혜자는 휴학 시 장학금 반환 또는 미등록휴학 신청 필요",
      },
    ],
    quickReplies: [
  ...
  "scholarship-loan": {
    id: "scholarship-loan",
    intro:
      "학자금대출도 장학금과 마찬가지로 대림대가 아니라 한국장학재단을 통해 신청해요. 절차는 아래 7단계로 진행돼요.",
    topLink: { label: "🔍 한국장학재단 바로가기", url: OFFICIAL_LINKS.kosaf },
    cards: [
      {
        title: "STEP 1~2. 대출준비 · 대출신청",
        body: "해당 은행 공인인증서 발급 후, 일반·취업후·농어촌 학자금대출 중 본인에게 맞는 유형으로 신청서를 작성해요.",
      },
      {
        title: "STEP 3. 금융교육 (필수)",
        body: "학자금대출 신청 시 e-러닝 금융교육을 반드시 이수해야 해요.",
      },
      {
        title: "STEP 4~5. 가구원 동의 · 서류제출",
        body: "대출 승인을 위해 학부생은 가구원(부모/배우자) 동의가 필요해요. 소득분위(구간) 파악을 위한 가족정보 관련 서류도 필요 시 제출해요.",
      },
      {
        title: "STEP 6~7. 대출승인 · 대출실행",
        body: "대출심사 결과를 확인하고(심사요건 미달 시 특별추천 가능), 공인인증서로 대출금 지급을 실행해요.",
      },
      {
        title: "신청 시기 꼭 확인하세요",
        body: "학자금 지원구간 산정에 약 8주가 걸려요. 원활한 대출 실행을 위해 등록마감 8주 전까지는 신청해야 해요.",
      },
      {
        title: "가구원 동의가 필요 없는 경우",
        body: "농어촌출신 대학생 학자금융자 신청대상 중 농어업종사자, 취약계층가구, 다자녀(3자녀 이상) 가구는 가구원 동의가 필요 없어요.",
      },
    ],
    quickReplies: [
      { label: "장학 메뉴로", targetId: "scholarship" },
  ...
  "scholarship-external": {
    ...
    cards: [
      {
        title: "교외장학이란",
        body: "장학재단 등 교외 기탁기관이 지정한 장학이에요. 기탁기관이 대학에 장학생 추천을 의뢰 → 학과 추천 의뢰·홈페이지 공지 → 학생이 구비서류와 함께 접수(또는 학과 접수) → 학교 검토 후 기탁기관에 추천 → 기탁기관에서 선발·지급 확정 → 장학금 지급 순서로 진행돼요.",
        link: { label: "장학안내 페이지에서 자세히 보기", url: OFFICIAL_LINKS.scholarship },
      },
      {
        title: "세종이도인재장학금",
  ...
  "scholarship-apply": {
    ...
    intro:
      "장학금은 종류마다 신청 방법이 달라요. 대부분은 별도 신청 없이 학과·부서 추천이나 학교 선발로 결정되고, 일부만 학생이 직접 포털에서 신청해요.",
    cards: [
      {
        title: "대부분의 교내장학금 (신청 불필요)",
        body: "성적 A·B·C·D, 산업체위탁·전공심화장학, 입학우수장학, 외국인학생·외국인유학생 성적장학, 교내복지장학, 보훈장학, 대림가족장학, 봉사·근로·글로벌·특별 계열 장학 등은 학과(부)장 추천이나 대학 자체 선발로 결정돼요. 별도로 신청할 필요 없이 학기 초 성적·학적 기준만 충족하면 대상자로 검토돼요.",
      },
      {
        title: "학생이 직접 신청하는 교내장학금",
        body: "대림나눔장학·대림사랑장학·대림다문화장학은 학생이 직접 학생포털에서 신청해야 해요. 신청기간은 보통 5월·11월(대림나눔장학은 5월·11월)이니 공지사항을 확인해주세요.",

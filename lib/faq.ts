...
export const FAQ_ITEMS: FaqItem[] = [
  // ----- 장학금 (2026학년도 2학기 국가장학금/국가근로장학금/우선감면/주거안정장학금 공지 기준) -----
  {
    ...
    answer:
      "교내장학금이 20종 넘게 있어요. 등록금성 장학(성적 A·B·C·D, 입학우수, 산업체위탁·전공심화, 면학장학, 외국인유학생 성적장학, 교내복지, 보훈, 대림가족 등)과 생활비성 장학(봉사장학, 교내근로, 대림나눔·대림사랑·대림다문화, GLOBAL 어학·글로벌리더스챌린지·BeACE·학군단·특별장학 등)으로 나뉘고, 그 외 국가장학금·국가근로장학금·주거안정장학금(한국장학재단)과 교외장학금도 있어요.",
  ...
  },
  {
    ...
    answer:
      "대부분의 교내장학금(성적·입학우수·산업체위탁·전공심화·보훈·봉사·근로장학 등)은 별도 신청 없이 학과(부)장 추천이나 대학 자체 선발로 결정돼요. 대림나눔장학·대림사랑장학·대림다문화장학만 학생이 직접 대림대 포털에서 신청해야 하고요. 국가장학금·국가근로장학금·주거안정장학금은 대림대 포털이 아니라 한국장학재단 홈페이지/모바일 앱에서 신청해야 해요.",
  ...
  {
    id: "scholarship-loan",
    keywords: ["학자금대출", "학자금 대출", "대출 신청"],
    question: "학자금대출은 어떻게 신청하나요?",
    answer:
      "대림대 포털이 아니라 한국장학재단에서 신청해요. 은행 공인인증서 발급 → 대출신청서 작성 → e-러닝 금융교육 이수(필수) → 가구원 동의·서류제출 → 대출승인 → 대출실행 순이에요. 학자금 지원구간 산정에 약 8주가 걸리니 등록마감 8주 전까지는 신청해주세요.",
    link: { label: "한국장학재단 바로가기", url: OFFICIAL_LINKS.kosaf },
  },
  {
  ...
  },
  {
    ...
    answer:
      "학교 자동발급기(홍지관 2층 카페앞, 대학본부 1층, 율곡관 3층 자판기옆), 가까운 시·군·구청·행정복지센터의 FAX민원 발급, 인터넷증명발급센터(회원가입 필요) 중에서 선택할 수 있어요. 자동발급기는 재학생은 포털과 동일한 학번/비밀번호로, 졸업생은 PASS·카카오·토스 등 본인인증으로 로그인해요. 인터넷증명발급센터는 발급료·대행수수료가 최종결제금액으로 표시되는 유료 서비스예요.",
    link: { label: "인터넷 증명발급센터 바로가기", url: OFFICIAL_LINKS.certificateIssueCenter },
  },
  {
    id: "certificate-fee",
    keywords: ["증명서 무료", "증명서 유료", "증명서 비용", "증명서 수수료", "증명서 결제", "증명서 온라인 발급"],
    question: "인터넷으로 증명서 발급받으면 무료인가요?",
    answer:
      "무료가 아니에요. 인터넷증명발급센터에서 발급할 증명서를 선택하면 발급료와 대행수수료가 합쳐진 최종결제금액이 표시되고, 신용카드·휴대폰 결제 등을 선택해 결제를 완료해야 발급돼요. 결제 완료 후에는 [증명서보관함]에서 발급된 증명서를 바로 출력할 수 있어요.",
    link: { label: "인터넷 증명발급센터 바로가기", url: OFFICIAL_LINKS.certificateIssueCenter },
  },
